...
public class MyLocationPresenter {
    ...
    public MyLocationPresenter(MyLocationActivity activity) {
        ...
        satelliteHeader = activity.getResources().getString(R.string.satelliteHeader);
    ...
    public void locationStart() {
        ...
        if (isGetSatellite) {
            ...
            activity.registerReceiver(locationReceiver, satelliteFilter);
    ...
    public void locationStop() {
        ...
        if (runService != null) {
            ...
            try {
                activity.unbindService(runService);
                if(isGetSatellite){
                    activity.unbindService(serviceConnectiongetSatellite);
                }
    ...
    public class LocationReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if(receiveCategory.equals(categoryGetSatellite)) {
